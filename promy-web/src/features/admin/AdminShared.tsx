...
// ─── ConfirmDialog ────────────────────────────────────────────────────────────
// Diálogo de confirmación simple para acciones destructivas que NO usan
// ModerationModal (por ejemplo: ocultar un comercio o promo de la app).
// Uso:
//   <ConfirmDialog
//     open={showConfirm}
//     title="Ocultar comercio de la app"
//     description="Los usuarios dejarán de ver este comercio..."
//     confirmLabel="Sí, ocultar"
//     tone="danger"
//     onClose={() => setShowConfirm(false)}
//     onConfirm={() => { setShowConfirm(false); void doTheSave(); }}
//   />
  ...
  return (
    <div className="modal-backdrop" onClick={onClose} role="presentation">
      <div
        ...
        aria-modal="true"
      >
        <div className="page-kicker">Confirmación</div>
        <h2>{title}</h2>
