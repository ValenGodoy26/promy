...
import SentryBridge from "./components/SentryBridge";
import CommerceRegisterPage from "./features/public/CommerceRegisterPage";
import PublicLegalPage from "./features/public/LegalPage";
        ...
        <div className="landing-roles-grid-2col">
          ...
          <article className="role-card-v2 role-card-client" id="app">
            ...
            <div className="role-card-bullets-v2">
              ...
              <span className="role-card-bullet-v2"><IconCheck size={12} /> App cliente con acceso privado</span>
            </div>
            <Link
