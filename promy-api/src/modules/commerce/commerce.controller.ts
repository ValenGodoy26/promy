...
import {
  ...
  updateCommerceStatusSchema,
  updateCommerceSchema,
  updateManagedCommerceByOwner,
  updateManagedCommerceStatusByOwner,
...
export const getCommerceDashboard = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Get commerce dashboard error", error);
...
export const getMyCommerce = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Get my commerce error", error);
    return res.status(500).json({
      ok: false,
...
export const updateMyCommerce = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Update my commerce error", error);
    return res.status(500).json({
      ok: false,
...
export const updateMyCommerceStatus = async (req: AuthRequest, res: Response) => {
  try {
    const userId = req.user?.userId;
    ...
    const parsed = updateCommerceStatusSchema.safeParse(req.body);
    ...
    const updatedCommerce = await updateManagedCommerceStatusByOwner({
      ownerUserId: userId,
    ...
    return res.status(200).json({
      ok: true,
      message:
        updatedCommerce.status === "INACTIVE"
          ? "Tu comercio quedo pausado. Dejara de aparecer en el catalogo publico."
          : "Tu comercio volvio a estar activo en PROMY.",
      commerce: updatedCommerce,
    });
  } catch (error: unknown) {
    const handled = handleCommerceServiceError(error, res);
    ...
    logControllerError(req, "Update my commerce status error", error);
    return res.status(500).json({
      ok: false,
...
export const getMyPromotions = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Get my promotions error", error);
    return res.status(500).json({
      ok: false,
...
export const createMyPromotion = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Create my promotion error", error);
    return res.status(500).json({
      ok: false,
...
export const updateMyPromotion = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Update my promotion error", error);
    return res.status(500).json({
      ok: false,
...
export const deleteMyPromotion = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Delete my promotion error", error);
    return res.status(500).json({
      ok: false,
...
export const getMyRedemptions = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Get my commerce redemptions error", error);
    return res.status(500).json({
      ok: false,
...
export const validateCommerceRedemption = async (req: AuthRequest, res: Response) => {
  try {
    ...
    logControllerError(req, "Validate commerce redemption error", error);
    return res.status(500).json({
      ok: false,
