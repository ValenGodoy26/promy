...
export type AuthUser = {
  ...
  country?: string | null;
  gender?: "WOMAN" | "MAN" | "NON_BINARY" | "PREFER_NOT_TO_SAY" | "OTHER" | string | null;
...
export type CommercesResponse = PaginationMeta & {
  ok: boolean;
...
export type PromotionsResponse = PaginationMeta & {
  ok: boolean;
