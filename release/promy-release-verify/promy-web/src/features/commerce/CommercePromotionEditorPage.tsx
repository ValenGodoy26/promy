...
import { IconAlert, IconArrowLeft, IconCheck, IconClock, IconTrash } from "../../components/Icons";
import {
...
export function CommercePromotionEditorPage({
  ...
  const handleDelete = async () => {
    ...
    if (!window.confirm("Si la promocion no tiene canjes asociados, la vamos a eliminar permanentemente.")) {
      return;
    }
    try {
      setSaving(true);
