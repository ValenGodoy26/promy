...
export const getCommerces = async (req: Request, res: Response) => {
  try {
    ...
    const commerces = await getCommercesCatalog(parsed.data);
    ...
    console.error("Get commerces error:", error);
...
export const getCommerceById = async (req: Request, res: Response) => {
  try {
    ...
    console.error("Get commerce by id error:", error);
...
export const getNearbyCommerces = async (req: Request, res: Response) => {
  try {
    ...
    console.error("Get nearby commerces error:", error);
