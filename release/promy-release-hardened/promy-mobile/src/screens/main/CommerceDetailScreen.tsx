...
import PromoImagePlaceholder from "../../components/promy/PromoImagePlaceholder";
import {
  BadgePill,
  EmptyState,
  ErrorState,
        ...
        {loading ? (
          ...
          <>
            ...
            <View style={styles.heroWrap}>
              {commerceImage ? (
                ...
                <PromoImagePlaceholder
                  ...
                  title={getCommerceHeadline(commerce)}
                  label="Local adherido"
            ...
            <View style={styles.body}>
              ...
              <View style={styles.useGuideCard}>
                <View style={styles.useGuideIcon}>
                  <Feather name="check-square" size={16} color={theme.colors.accentRed} />
                </View>
                <View style={styles.useGuideBody}>
                  <Text style={styles.useGuideTitle}>Cómo usar promos en este local</Text>
                  <Text style={styles.useGuideText}>
                    Mostrá la promo antes de pagar. El comercio valida el código o QR y listo.
                  </Text>
                  <View style={styles.useGuideSteps}>
                    <View style={styles.useGuideStep}>
                      <Text style={styles.useGuideStepText}>1 · Elegí</Text>
                    </View>
                    <View style={styles.useGuideStep}>
                      <Text style={styles.useGuideStepText}>2 · Mostrá</Text>
                    </View>
                    <View style={styles.useGuideStep}>
                      <Text style={styles.useGuideStepText}>3 · Validan</Text>
                    </View>
                  </View>
                </View>
              </View>
                  ...
                  <View style={styles.featuredFooter}>
                    <View style={styles.featuredTiming}>
                      ...
                      <Text style={styles.featuredTimingText}>
                        Validada · {buildPromotionTiming(featuredPromotion) || "Disponible hoy"}
                      </Text>
                    </View>
              ...
              <View style={styles.sectionCard}>
                ...
                <ContactRow
                  icon="clock"
                  value={featuredPromotion ? buildPromotionTiming(featuredPromotion) || "Disponible según vigencia de la promo" : "Horario disponible pronto"}
                />
                <ContactRow
                  icon="phone"
              ...
              {sortedPromotions.length > 0 ? (
                ...
                <EmptyState
                  title="Este comercio todavía no cargó promos"
                  message="Estamos esperando que el local active sus beneficios. Cuando haya una promo, va a aparecer acá."
                  icon={<Feather name="tag" size={22} color={theme.colors.accentRed} />}
                />
              )}
            </View>
          </>
    ...
    <TouchableOpacity activeOpacity={0.92} style={styles.promoCard} onPress={onPress}>
      <View style={styles.promoMedia}>
        {commerceImage ? (
          ...
          <PromoImagePlaceholder
            variant="thumb"
            commerceName={promotion.title}
            categoryName={promotion.promotionType}
            label={getPromotionBadgeLabel(promotion)}
            style={styles.promoFallback}
          />
        )}
      ...
      <View style={styles.promoBody}>
        ...
        <Text style={styles.promoDesc} numberOfLines={2}>
          {promotion.description ||
            ...
            "Promo activa y validada por el comercio."}
        </Text>
        <View style={styles.promoFooter}>
          <Text style={styles.promoTiming}>
            Validada por el comercio · {timing || "Disponible hoy"}
          </Text>
