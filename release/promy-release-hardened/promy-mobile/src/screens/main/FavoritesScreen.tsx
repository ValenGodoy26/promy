      ...
      <View style={styles.promoImageWrap}>
        {image ? (
          ...
          <PromoImagePlaceholder
            ...
            categoryName={item.commerce.category?.name}
            title={item.title}
            label={getPromotionBadgeLabel(item)}
...
export default function FavoritesScreen() {
  ...
  const favoritePromotionsSorted = useMemo(() => {
    return [...favoritePromotions].sort((a, b) => {
      if (sortOrder === "name") {
  ...
  }, [favoritePromotions, sortOrder]);
  const favoriteCommercesSorted = useMemo(() => {
    return [...favoriteCommerces].sort((a, b) => {
      if (sortOrder === "name") {
  ...
  }, [favoriteCommerces, sortOrder]);
  const activeList = useMemo(() => {
    return filter === "promotions" ? favoritePromotionsSorted : favoriteCommercesSorted;
  }, [favoriteCommercesSorted, favoritePromotionsSorted, filter]);
        ...
        <View style={styles.heroBlock}>
          ...
          <View style={styles.heroCopy}>
            ...
            <Text style={styles.heroSubcopy}>
              {filter === "promotions"
                ? "Tus promos guardadas para volver rápido cuando quieras canjear."
                : "Tus locales favoritos para revisar promos y abrir el mapa sin empezar de cero."}
            </Text>
          </View>
        </View>
        ...
        {isLoadingFavorites ? (
          ...
          filter === "promotions" ? (
            <View style={styles.promoGrid}>
              {favoritePromotionsSorted.map((item) => (
            ...
            <View style={styles.commerceList}>
              {favoriteCommercesSorted.map((item) => (
