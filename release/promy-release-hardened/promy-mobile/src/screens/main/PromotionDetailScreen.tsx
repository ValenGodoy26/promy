            ...
            <View style={styles.heroWrap}>
              {image ? (
                ...
                <PromoImagePlaceholder
                  ...
                  categoryName={promotion.commerce.category?.name}
            ...
            <View style={styles.body}>
              ...
              <View style={styles.trustRow}>
                <View style={styles.trustPill}>
                  ...
                  <Text style={styles.trustText}>Validada por el comercio</Text>
                </View>
                <View style={styles.trustPill}>
                  <Feather name="clock" size={12} color={theme.colors.textMuted} />
                  <Text style={styles.trustText}>Disponible hoy</Text>
                </View>
                {promotion.distanceKm != null ? (
                  <View style={styles.trustPill}>
                    <Feather name="navigation" size={12} color={theme.colors.textMuted} />
                    <Text style={styles.trustText}>{formatDistance(promotion.distanceKm)}</Text>
                  </View>
                ) : null}
              </View>

              <Text style={styles.useHint}>
                Mostrá este beneficio en el local antes de pagar. Sin puntos ni vueltas raras.
              </Text>
                  ...
                  {existingRedemption.validationMethod === "QR" ? (
                    <View style={styles.qrCard}>
                      <View style={styles.qrWrap}>
                        <QRCode
                          value={buildValidationDeepLink(existingRedemption.validationCode)}
                          size={172}
