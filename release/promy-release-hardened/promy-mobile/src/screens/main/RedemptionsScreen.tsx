...
function SegmentedFilters({
  ...
  const options: Array<{ id: Filter; label: string; count: number }> = [
    ...
    { id: "success", label: "Validados", count: successCount },
        ...
        <View style={styles.statsCard}>
          ...
          <View style={styles.statsItem}>
            <View style={styles.statsPillGreen}>
              ...
              <Text style={styles.statsPillGreenText}>Validados</Text>
            </View>
        ...
        {loading ? (
          ...
          <View style={styles.list}>
            {filteredRedemptions.map((item) => {
              ...
              const statusText = isSuccess ? "Canje validado" : isPending ? "Canje pendiente" : "Canje vencido";
                ...
                >
                    ...
                    <View style={styles.qrCard}>
                      ...
                      <View style={styles.qrBody}>
                        <View style={styles.qrCanvas}>
                          <QRCode
                            value={buildValidationDeepLink(item.validationCode)}
                            size={112}
                          />
                        </View>
                  ...
                  <View style={styles.cardBottomRow}>
                    <Text style={styles.cardHint}>
                      {isSuccess
                        ? "Canje validado en el comercio."
                        : isPending
                        ? "Mostrá el código o QR antes de pagar."
                        : "Este canje ya no está disponible."}
                    </Text>
          ...
          <EmptyState
            title={
              filter === "pending"
                ...
                : filter === "success"
                ? "Todavia no tenes canjes validados"
                : filter === "failed"
                ? "No hay canjes fallidos"
                : "Todavia no generaste canjes"
            }
            message={
              filter === "all"
                ? "Cuando elijas una promo, el código o QR va a quedar guardado acá para usarlo en el local."
                : "Probá cambiando el filtro o descubrí promos nuevas."
            }
