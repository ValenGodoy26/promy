    ...
    <SafeAreaView edges={["top"]} style={styles.header}>
      ...
      <View style={styles.headerTopRow}>
        <View style={styles.locationRow}>
          <PromoLogo size="sm" />
          <View>
            <Text style={styles.locationLabel}>{locationCaption}</Text>
  ...
  return (
    <View style={styles.skeletonWrap}>
      <View style={styles.skeletonHero}>
        <SkeletonBlock width="36%" height={12} radius={999} />
      ...
      <View style={styles.skeletonSectionHeader}>
        <SkeletonBlock width="48%" height={12} radius={999} />
        <SkeletonBlock width={64} height={18} radius={999} />
      </View>

      <View style={styles.skeletonCardRow}>
        <SkeletonBlock width={220} height={246} radius={28} style={styles.skeletonCardSurface} />
        <SkeletonBlock width={220} height={246} radius={28} style={styles.skeletonCardSurface} />
      </View>
      ...
      <SkeletonBlock height={92} radius={24} style={styles.skeletonCardSurface} />
      <SkeletonBlock height={92} radius={24} style={styles.skeletonCardSurface} />
    </View>
  );
}

export function HomeFeedFooterSkeleton() {
  return (
    <View style={styles.feedFooterSkeleton}>
      <View style={styles.skeletonSectionHeader}>
        <SkeletonBlock width="42%" height={12} radius={999} />
        <SkeletonBlock width={58} height={18} radius={999} />
      </View>
      <View style={styles.skeletonCardRow}>
        <SkeletonBlock width={220} height={246} radius={28} style={styles.skeletonCardSurface} />
        <SkeletonBlock width={220} height={246} radius={28} style={styles.skeletonCardSurface} />
    ...
    >
      ...
      <View style={styles.heroBody}>
        <View style={styles.heroTextCol}>
          ...
          <View style={styles.heroTrustRow}>
            <View style={styles.heroTrustPill}>
              ...
              <Text style={styles.heroTrustText}>Disponible hoy</Text>
            </View>
            <View style={styles.heroTrustPill}>
              <Feather name="map-pin" size={10} color="#FFFFFF" />
              <Text style={styles.heroTrustText}>{formatDistance(promotion.distanceKm) || "Cerca"}</Text>
            </View>
          </View>
          ...
          <View style={styles.heroDiscountRow}>
            ...
            <Text style={styles.heroSavingsText}>Validada por el comercio</Text>
          </View>
        ...
        <PromoPreview
          ...
          categoryName={promotion.commerce.category?.name || promotion.categoryName}
          ...
          >
            ...
            <View style={styles.hotCardBody}>
              ...
              <View style={styles.hotFooterRow}>
                <Text style={styles.hotPrice} numberOfLines={1}>
                  {promotion.commerce.category?.name || promotion.categoryName || "Disponible hoy"}
                </Text>
                <View style={styles.hotDistanceRow}>
                  ...
                  <Feather name="chevron-right" size={12} color={theme.colors.textMuted} />
                </View>
              </View>
            </View>
          </TouchableOpacity>
...
export function PromoRailSection({
  ...
  return (
    <>
      <HomeSectionHeader title={title} actionLabel={actionLabel} onAction={onAction} />
      <FlashList
        data={promotions}
        horizontal
        showsHorizontalScrollIndicator={false}
        ...
        keyExtractor={(promotion) => `rail-${title}-${promotion.id}`}
        renderItem={({ item: promotion }) => (
          <TouchableOpacity
            activeOpacity={0.92}
          ...
          >
            <PromoPreview
              ...
              label={getPromotionBadgeLabel(promotion)}
              compact
              style={styles.railPreview}
            />
            <View style={styles.railBody}>
              <View style={styles.railBadge}>
                <Feather name={badgeIcon} size={10} color={theme.colors.accentRed} />
                <Text style={styles.railBadgeText}>{badgeLabel}</Text>
              </View>
              <Text style={styles.railCommerce} numberOfLines={1}>
                {promotion.commerce.name}
              </Text>
              ...
              <Text style={styles.railMeta} numberOfLines={1}>
                {promotion.commerce.category?.name || promotion.categoryName || "Promo activa"} ·{" "}
                {formatDistance(promotion.distanceKm) || "Cerca"}
              </Text>
            </View>
          </TouchableOpacity>
            ...
            <View style={styles.nearBody}>
              ...
              <View style={styles.nearMetaRow}>
                <View style={styles.nearCategoryPill}>
                  <Feather name="check" size={9} color="#8A5A2A" />
                  <Text style={styles.nearCategoryText}>{promotion.categoryName || "Disponible hoy"}</Text>
                </View>
    ...
    <>
      ...
      {hasActivity ? (
        ...
        <View style={styles.emptyActivity}>
          <Text style={styles.emptyActivityTitle}>Todavia no usaste promos</Text>
          <Text style={styles.emptyActivityText}>
            Cuando generes tu primer canje, queda guardado aca con el estado de validacion.
          </Text>
        </View>
      )}
    </>
