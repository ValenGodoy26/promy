...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    author: "Equipo PROMY",
    location: "CONCORDIA Â· PRIMERA ETAPA",
    avatar: "J",
...
const faqs: Faq[] = [
  {
    ...
    answer:
      "PROMY es una app mobile que te muestra promociones, descuentos y beneficios reales de comercios locales cerca de donde estÃ¡s. Funciona con geolocalizaciÃ³n y hoy estÃ¡ en etapa beta.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "En esta etapa beta, la app no tiene costo para el usuario. Si eso cambia mÃ¡s adelante, lo vamos a comunicar de forma clara.",
  },
  {
...
function App() {
  ...
  const handleBetaRequestSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!normalizedEmail) {
      setBetaError("Necesitamos un email valido para avisarte cuando abramos nuevos cupos.");
      return;
    }
    ...
    try {
      ...
      setBetaSuccess(
        data.message ||
          "Listo. Guardamos tu pedido y te vamos a avisar apenas abramos nuevos cupos.",
      );
      setBetaEmail("");
    } catch (error) {
      setBetaError(
          ...
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <p className="subtle reveal delay-4" style={{ marginTop: 10 }}>
                Elige plataforma, dejanos tu email y te avisamos cuando abramos nuevos cupos.
              </p>
            ...
            <div className="bcard b7 reveal delay-3">
              <div className="bcard-column">
                ...
                <div>
                  ...
                  <p>Estamos abriendo la beta de forma gradual para afinar la experiencia con comercios y promos reales.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="final-inner">
            ...
            <p className="final-sub reveal delay-2">
              La app cliente se esta abriendo por etapas. Sumate a la lista y te avisamos apenas habilitemos nuevos accesos para tu plataforma.
            </p>
            ...
            <p className="subtle reveal delay-3" style={{ marginTop: 10 }}>
              Guardamos tu pedido en PROMY para avisarte apenas abramos nuevos cupos para tu plataforma.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="faq-grid">
            <div className="reveal">
              ...
              <p className="subtle faq-copy">
                Tienes una duda puntual sobre la beta, los comercios o como funciona PROMY? Escribinos a{" "}
