...
export function AdminBetaRequestsPage({
  ...
  return (
    <>
      <PageHeader kicker="/ Admin · Growth" title="Lista beta" titleAccent="interesados" tabs={tabs} />
      ...
      <div className="main-content">
        ...
        >
          <StatCard label="Registros cargados" value={total} sub="lista de espera total" />
        ...
        {loading ? (
          <LoadingBlock title="Cargando lista beta" text="Leyendo interesados y plataformas." />
        ) : (
          <div className="detail-layout">
                  ...
                  {requests.map((request) => (
                    ...
                    >
                      <td>
                        ...
                        <span className="cell-sub">Lead #{request.id}</span>
                      </td>
            ...
            {selected ? (
              <aside className="detail-card">
                <div className="page-kicker">Lead beta</div>
